...
figure
plot(1:400, J_history1(1:400), 'b');
hold on;
plot(1:400, J_history2(1:400), 'r');
hold on;
plot(1:400, J_history3(1:400), 'k');
hold on;
plot(1:400, J_history4(1:400), 'g');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i=1:2
    test_input(:,i) = ( test_input(:,i)- mu(i) ) /sigma(i);
end
test_input = [1, test_input] %add theta0

price = test_input*theta;
% ============================================================
